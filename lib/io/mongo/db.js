...
console.log("looking for", symbolName, "in", exchangeId, "between", day, "and", nextDay);
	var filters = {
		"symbolName": symbolName,
		"exchangeId": exchangeId,
		"dateTime": {"$gte": day.toISOString(), "$lt": nextDay.toISOString()}
		//"dateTime": {"$gte": "2015-03-09 16:00:00.000Z", "$lt": "2015-03-09 17:00:00.000Z"}
